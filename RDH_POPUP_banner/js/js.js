            ...
            */
            $('.main-posts').each(function(){
				...
				if (rightblock.length)
				{
					...
					//console.log('rightblock_height = ' + rightblock.height());

					
					if ( rightblock.height() > w_height && rightblock.height() - window_top + el_top <= w_height )
					{
					...
					if (  rightblock.height() - window_top > w_height )
					{
						...
						//console.log('блок рядом с контентом')
					}
